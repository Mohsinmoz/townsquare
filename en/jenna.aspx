<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="jenna.aspx.cs" Inherits="TownSquare.Web.en.jenna" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="popup-content">
        <div class="popup-content-all">
            ...
            <uc1:CampaignForm runat="server" ID="CampaignForm" CampaignName="Jenna" />
        </div>
 ...
 <div class="center zaharaptb">
   ...
   <section class="payment-plan">
    ...
    <uc2:RegisterProjectsControl CampaignName="Jenna" runat="server" ID="RegisterProjectsControl" />
    </div>
   </section> 
  ...
  <script type="text/javascript">
      ...
      function floodinglightJenna()
      {
          var axel = Math.random() + "";
          var a = axel * 10000000000000;
          document.write('<iframe src="https://1727330.fls.doubleclick.net/activityi;src=1727330;type=nshama;cat=jenna2;ord=' + a + '?" width="1" height="1" frameborder="0" style="display:none"></iframe>');
      }

      //$('#ContentPlaceHolder1_RegisterProjectsControl_noofbedrooms').attr('selected', 'selected');
    </script>
    <noscript>
    <iframe src="https://1727330.fls.doubleclick.net/activityi;src=1727330;type=nshama;cat=jenna2;ord=1?" width="1" height="1" frameborder="0" style="display:none"></iframe>
    </noscript>
</asp:Content>
