<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="hayat-townhouses.aspx.cs" Inherits="TownSquare.Web.en.Hayattownhouse" MasterPageFile="~/Main.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="popup-content">
        <div class="popup-content-all">
            ...
            <img id="close" src="/img/content/popup-image-hayat.jpg" class="pop-up-image" />
            ...
            <uc1:CampaignForm CampaignName="Hayat Town Houses" runat="server" ID="CampaignForm" />
        </div>
   ...
   <div class="main">
    <div class="banner">
     <img src="../../img/content/hayat.jpg" alt="" />
   ...
   <section class="block-2 inverse">
    <div class="block-left">
     <img src="../../img/content/hayat-01.jpg" alt="" />
    ...
    <div class="block">
     <div class="copy">
      <h4> YOUR LIFE, FULL TO THE BRIM </h4>
      <p>
   ...
   <section class="gallery">
    ...
    <ul>
     <li>
      <img src="../../img/Hayattownhouse/gallery/01.jpg" alt="" />
     </li>
     <li>
      <img src="../../img/Hayattownhouse/gallery/02.jpg" alt="" />
     </li>
     <li>
      <img src="../../img/Hayattownhouse/gallery/03.jpg" alt="" />
     </li>
     <li>
      <img src="../../img/Hayattownhouse/gallery/04.jpg" alt="" />
     </li>
     <li>
      <img src="../../img/Hayattownhouse/gallery/05.jpg" alt="" />
     </li>
     <li>
      <img src="../../img/Hayattownhouse/gallery/06.jpg" alt="" />
     </li>
    </ul>
   </section>
   <section class="floorplan">
    ...
    <div class="copy">
     ...
     <div class="view-more">
      <a href="HayatTownHouses/floorplan.aspx"> view more </a>
     </div>
    </div>
   </section>
   <section class="payment-plan">
    <div class="wrapper">
     ...
     <div class="plans-list">
      <ul>       
       ...
       <li>
        <div class="plan-copy">
         <span> 100% contruction Completion and Handover </span>
         <h4> 5% </h4>
      ...
      *Tentative construction progress dates
        ...
        <section class="payment-plan zahra-breeze-payment-plan" id="hayat-townhouses-payment-plan"">
    ...
    <uc2:RegisterProjectsControl CampaignName="Hayat Town Houses" runat="server" ID="RegisterProjectsControl" />
    </div>
   </section> 
